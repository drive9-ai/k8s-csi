...
```text
ghcr.io/drive9-ai/drive9-csi:drive9-6e2820e-csi-1f8e5cd
```
...
`6e2820e...` and CSI commit `1f8e5cd...`:
...
```sh
make image IMAGE=ghcr.io/drive9-ai/drive9-csi:drive9-6e2820e-csi-1f8e5cd
docker push ghcr.io/drive9-ai/drive9-csi:drive9-6e2820e-csi-1f8e5cd
```
...
export DRIVE9_CSI_IMAGE=ghcr.io/drive9-ai/drive9-csi:drive9-6e2820e-csi-1f8e5cd
...
ghcr.io/drive9-ai/drive9-csi:drive9-6e2820e-csi-1f8e5cd` works without
`docker login`.
