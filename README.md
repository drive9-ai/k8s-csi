...
```text
ghcr.io/drive9-ai/drive9-csi:drive9-6e2820e-csi-126ff81
```
...
`6e2820e...` and CSI commit `126ff81...`:
...
```sh
make image IMAGE=ghcr.io/drive9-ai/drive9-csi:drive9-6e2820e-csi-126ff81
docker push ghcr.io/drive9-ai/drive9-csi:drive9-6e2820e-csi-126ff81
```
...
export DRIVE9_CSI_IMAGE=ghcr.io/drive9-ai/drive9-csi:drive9-6e2820e-csi-126ff81
...
ghcr.io/drive9-ai/drive9-csi:drive9-6e2820e-csi-126ff81` works without
`docker login`.
